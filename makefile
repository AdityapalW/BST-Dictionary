...
td: BSTTestDriver.o Word.o BST.o BSTNode.o ElementAlreadyExistsException.o ElementDoesNotExistException.o EmptyDataCollectionException.o UnableToInsertException.o
	g++ -Wall -o td BSTTestDriver.o Word.o BST.o BSTNode.o ElementAlreadyExistsException.o ElementDoesNotExistException.o EmptyDataCollectionException.o UnableToInsertException.o
	
BSTTestDriver.o: BSTTestDriver.cpp
	g++ -Wall -c BSTTestDriver.cpp 
		
WordPair.o: Word.h Word.cpp
	g++ -Wall -c Word.cpp
